...
export default async function Page() {
  ...
  return (
    <main className="flex flex-col min-h-[100dvh] space-y-10 px-4 sm:px-6 md:px-8">
              ...
              <div className="space-y-2 flex-1">
                ...
                <BlurFade delay={BLUR_FADE_DELAY * 3}>
                  <div className="flex flex-wrap items-center gap-2">
                    <div className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-white border border-gray-300 text-xs text-gray-900">
                    ...
                    <div className="flex items-center gap-1.5">
                      <Link
                        ...
                        className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-lg bg-white border border-gray-300 text-xs text-gray-900 hover:bg-gray-50 transition-colors"
                      >
      ...
      <section id="os-contributions" className="mt-12">
        <div className="mx-auto w-full max-w-2xl">
          <div className="flex min-h-0 flex-col gap-y-4">
            <BlurFade delay={BLUR_FADE_DELAY * 4}>
              <h2 className="text-xl font-semibold tracking-tighter sm:text-2xl">OS Contributions</h2>
            </BlurFade>
        ...
        <div className="space-y-12 w-full pt-4 pb-12">
          <div className="max-w-2xl mx-auto">
            <BlurFade delay={BLUR_FADE_DELAY * 5}>
              <h2 className="text-xl font-semibold tracking-tighter sm:text-2xl">Work Experience</h2>
            </BlurFade>
          </div>
          <div className="max-w-2xl mx-auto">
        ...
        <div className="mx-auto w-full max-w-2xl">
          <div className="flex min-h-0 flex-col gap-y-6">
            <BlurFade delay={BLUR_FADE_DELAY * 7}>
              <h2 className="text-xl font-semibold tracking-tighter sm:text-2xl">Education</h2>
            </BlurFade>
        ...
        <div className="mx-auto w-full max-w-2xl">
          <div className="flex min-h-0 flex-col gap-y-6">
            <BlurFade delay={BLUR_FADE_DELAY * 9}>
              <h2 className="text-xl font-semibold tracking-tighter sm:text-2xl">Skills</h2>
            </BlurFade>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {(skills as readonly string[]).map((skill, skillIndex) => (
                        ...
                        >
                          <span className="px-3 py-1.5 text-xs font-medium rounded-md bg-white text-gray-900 border border-gray-300 hover:bg-gray-100 transition-colors">
                            {skill}
                          </span>
                        </BlurFade>
                      ))}
      ...
      <section id="articles" className="w-full py-12">
        <div className="max-w-2xl mx-auto space-y-8">
          <BlurFade delay={BLUR_FADE_DELAY * 14}>
            <div>
              <h2 className="text-xl font-semibold tracking-tighter sm:text-2xl">My thoughts on ... everything</h2>
            ...
            {posts
              ...
              .map((post, id) => (
                <BlurFade key={post.slug} delay={BLUR_FADE_DELAY * 14.5 + id * 0.05}>
                  ...
                  >
                    <div className="flex items-start gap-4 p-4 rounded-lg border border-border/50 bg-card/30 hover:bg-card/50 transition-all duration-300 hover:shadow-md">
        ...
        <div className="mx-auto w-full max-w-2xl">
          <div className="space-y-12 w-full py-12">
            <BlurFade delay={BLUR_FADE_DELAY * 15}>
              <h2 className="text-xl font-semibold tracking-tighter sm:text-2xl">Hackathons and Competitions</h2>
            </BlurFade>
      ...
      <section id="github-contributions" className="w-full py-12">
        <div className="max-w-2xl mx-auto space-y-8">
          <BlurFade delay={BLUR_FADE_DELAY * 18}>
            <h2 className="text-xl font-semibold tracking-tighter sm:text-2xl">GitHub Contributions</h2>
          </BlurFade>
